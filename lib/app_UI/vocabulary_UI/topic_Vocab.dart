import 'package:beelingual_app/app_UI/vocabulary_UI/level_Vocab.dart';
        ...
        child: RefreshIndicator(
          ...
          child: Column(
            children: [
              ...
              // Phần danh sách cuộn được mở rộng
              Expanded(
                  ...
                  builder: (context, snapshot) {
                    ...
                    return GridView.builder(
                      ...
                      gridDelegate: const SliverGridDelegateWithFixedCrossAxisCount(
                        ...
                        childAspectRatio: 0.8, // Chỉnh tỷ lệ để thẻ cao hơn chút cho đẹp
                      ),
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Material(
        ...
        child: InkWell(
          onTap: () {
            // Code mới (Thêm rootNavigator: true để che lấp menu dưới)
